...
```{r plotfitJo, fig.width=7, fig.height=4}                 
...
pinworms_dataPOS <- pinworms_data[pinworms_data$Aspiculuris.Syphacia > 0,]

fit_pinworms_negbinRES <- analyse(pinworms_dataPOS, response = "Aspiculuris.Syphacia+1", 
                               model = "negbin", group = "Sex")
