#' Fit the four cases for Student distribution of the expected load
#'
...
#' @return A fit for Student distributed data for all four cases
#' @export

runStudent <- function (data, response, hybridIndex, paramBounds, config) {
  results = list()
  methods = c(
    fitBasicNoAlpha = FitBasicNoAlphaStudent,
    fitBasicAlpha = FitBasicAlphaStudent,
    fitAdvancedNoAlpha = FitAdvancedNoAlphaStudent,
    fitAdvancedAlpha = FitAdvancedAlphaStudent
  )
