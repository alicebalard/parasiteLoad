...
runWeibull <- function (data, response, hybridIndex, paramBounds, config) {
  results = list()
  methods = c(
    fitBasicNoAlpha = FitBasicNoAlphaWeibull,
    fitBasicAlpha = FitBasicAlphaWeibull,
    fitAdvancedNoAlpha = FitAdvancedNoAlphaWeibull,
    fitAdvancedAlpha = FitAdvancedAlphaWeibull
  )
