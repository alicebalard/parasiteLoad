#' Fit the four cases for normal distribution of the expected load
#'
...
runNormal <- function (data, response, hybridIndex, paramBounds, config) {
  results = list()
  methods = c(
    fitBasicNoAlpha = FitBasicNoAlphaNormal,
    fitBasicAlpha = FitBasicAlphaNormal,
    fitAdvancedNoAlpha = FitAdvancedNoAlphaNormal,
    fitAdvancedAlpha = FitAdvancedAlphaNormal
  )
