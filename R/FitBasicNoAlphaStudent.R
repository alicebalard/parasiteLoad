#' Fit the model "no difference between subspecies, no hybrid effect" for Student distribution of the expected load
#'
...
#' @return A fit for Student distributed data for no difference between subspecies, no hybrid effect
#' @export
