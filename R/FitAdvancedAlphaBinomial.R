#' Fit the model "difference between subspecies, flexible hybrid effect" for binomial distribution of the expected load
#'
...
#' @return A fit for binomial distributed data for difference between subspecies, flexible hybrid effect
#' @export
